...
namespace StopWatch
{
    ...
    {
        // Design a class called Stopwatch. The job of this class is to simulate a stopwatch. It should provide two methods: Start and
        // Stop. We call the start method first, and the stop method next. Then we ask the stopwatch about the duration between start
        // and stop. Duration should be a value in TimeSpan. Display the duration on the console.
